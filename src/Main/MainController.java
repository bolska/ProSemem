...
import Main.Ano.AnoFXMLController;
...
public class MainController implements Initializable {
    ...
    private HBox differentCalendarViewRootPane = new HBox();
...
//        }
    ...
    private void startYearPage() {
        ...
        //Etapa1
        anoBox.setPrefSize(centerStackPane.getWidth(), centerStackPane.getHeight()); //Seta tamanho para vBox
        fullCalendarGridPane.setPrefSize(centerStackPane.getWidth(), centerStackPane.getHeight()); //Seta mesmo tamanho para o gridpane
